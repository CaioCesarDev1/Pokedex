...
const PokemonCard = ({pokemon}) => {
    ...
    return (
        <div className='cursor-pointer h-80 w-80 animate-fade-in transition ease-in-out delay-50 duration-500 hover:backdrop-blur-sm hover:bg-slate-800/25 flex flex-col backdrop-blur-md bg-gray-600/20 rounded-lg m-0 p-0'>
